...
const PPT_PROJECTS = [
  ...
  },
  {
    ...
    images: [
      ...
      ["./ppt-case-ipo-slide-02.jpg", "公司介绍"],
      ["./ppt-case-ipo-slide-03.jpg", "业务概览"],
      ["./ppt-case-ipo-slide-04.jpg", "服务范围"],
      ["./ppt-case-ipo-slide-05.jpg", "IPO 工作流程"],
      ["./ppt-case-ipo-slide-06.jpg", "上市要求"],
      ["./ppt-case-ipo-slide-07.jpg", "主板上市条件"],
      ["./ppt-case-ipo-slide-08.jpg", "18C 制度背景"],
      ["./ppt-case-ipo-slide-09.jpg", "专特科技定义"],
      ["./ppt-case-ipo-slide-10.jpg", "18C 制度对比"],
      ["./ppt-case-ipo-slide-11.jpg", "案例页（已打码）"],
      ["./ppt-case-ipo-slide-12.jpg", "联系页（已打码）"],
    ],
  },
  {
    id: "ppt-case-opera",
